...
const RegisterForm = () => {
  ...
  const registerNumberRef:any = useRef();
  const passwordRef:any = useRef();

  const handleSubmit = (e: MouseEvent<HTMLElement>) => {
    e.preventDefault();
    const email = emailRef.current.value;
    const registerNumber = registerNumberRef.current.value;
    const password = passwordRef.current.value;
    console.log(email, registerNumber, password);
  };
    ...
    <>
      <section className="bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:-m-12">
          ...
          >
            <Logo />
            <span className="text-2xl font-semibold text-blue-500">Regis</span>
            ter
          </a>
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-lg font-bold leading-tight tracking-tight text-gray-900 md:text-xl dark:text-white">
                Sign up via Student Portal credentials
              </h1>
